// use crate::base::{Endpoints, SyntaxEq, Tactic, Transform, TypedPoint};
// use crate::func;
// use crate::path;
...
// // type PathTransform = Transform<Path>;
// // type PathTactic = Transform<Path>;

// // impl Transform<Path> for Metapath {
// //     fn input(&self) -> Endpoints<Func> {
// //         self.endpoints().start().clone()
// //     }
// //     fn output(&self) -> Endpoints<Func> {
// //         self.endpoints().end().clone()
// //     }
// //     fn apply(&self, start: &Path) -> Path {
// //         self.unchecked_apply(start)
// //     }
// // }
